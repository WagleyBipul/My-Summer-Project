...
if(isset($_POST['filter_date'])){
  ...
  $sql9 = "SELECT * FROM booking WHERE bookday='$date' ";
  $result = $conn -> query ($sql9);


}
else{
  $sql = "SELECT * FROM booking ORDER BY bookday DESC";
  $result = $conn -> query ($sql);
} 
if(isset($_POST['submit'])){
   $id=$_POST['id'];
   $shift=$_POST['shift'];
   $sql2="DELETE  FROM booking WHERE id='$id' and shift='$shift'ORDER BY bookday DESC;";
